        ...
        <div class="profileContainer adminProfile">
            ...
            <div class="profileContent">
                ...
                <div class="profileActions adminActions">
                    <a href="${pageContext.request.contextPath}/ProfileS?action=edit" class="btnPrimary">
                        Edit Profile
                    </a>
                    <a href="${pageContext.request.contextPath}/AdminDashboardS" class="btnSecondary">
                        Dashboard
                    </a>
                    <a href="${pageContext.request.contextPath}/pages/manageUsers.jsp" class="btnSecondary">
                        Manage Users
                    </a>
                </div>
